...
```{r fig.width=10,fig.height=100,cache=T,echo=F,warning=F,message=F,error=F}
ggplot(cleanDat_l,aes(x=value))+
	geom_histogram()+
	facet_wrap(~desc,ncol=4,scales='free')


```{r fig.width=10,fig.height=33,cache=T,echo=F,warning=F,message=F,error=F}
...
```{r cache=T,echo=F,warning=F,message=F,error=F}
library(psych)
...
---
title: "svc_try_again.r"
author: "jflournoy"
date: "Fri Oct  9 17:05:37 2015"
---
