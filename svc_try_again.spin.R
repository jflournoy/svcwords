...
selfRateFAScaleScore <- selfRateFAScaleScoreClean1 
...
summary(rlm(
	SelfPop_1~1+admired+awkward+calm,
	data=selfRateFAScaleScores))
summary(rlm(
	SelfPop_2~1+admired+awkward+calm,
	data=selfRateFAScaleScores))
corr.test(
	select(selfRateFAScaleScores,matches('SelfPop')),
	select(selfRateFAScaleScores,admired,awkward,calm),
